...
proc init_gui { IPINST } {
  ...
  set NumSources [ipgui::add_param $IPINST -name "NumSources"]
  set_property tooltip {Number of interruption sources} ${NumSources}

}

proc update_PARAM_VALUE.NumSources { PARAM_VALUE.NumSources } {
	# Procedure called to update NumSources when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NumSources { PARAM_VALUE.NumSources } {
	# Procedure called to validate NumSources
	return true
}
...
proc update_MODELPARAM_VALUE.NumSources { MODELPARAM_VALUE.NumSources PARAM_VALUE.NumSources } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NumSources}] ${MODELPARAM_VALUE.NumSources}
}
