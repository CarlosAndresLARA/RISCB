...
proc init_gui { IPINST } {
  ...
  set NR_CORES [ipgui::add_param $IPINST -name "NR_CORES"]
  set_property tooltip {Number of Ariane cores} ${NR_CORES}

}

proc update_PARAM_VALUE.NR_CORES { PARAM_VALUE.NR_CORES } {
	# Procedure called to update NR_CORES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NR_CORES { PARAM_VALUE.NR_CORES } {
	# Procedure called to validate NR_CORES
	return true
}
...
proc update_MODELPARAM_VALUE.NR_CORES { MODELPARAM_VALUE.NR_CORES PARAM_VALUE.NR_CORES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NR_CORES}] ${MODELPARAM_VALUE.NR_CORES}
}
